...
Usage:  nh [--cls] [--trace] [--debug] SUBCMD [SUBARGS..]
  ...
  Generation of overrides:
   ...
   overrides [--reuse-cache] [--disable-ghc-configuration]
                             Generate overrides.nix.  --disable-ghc-configuration neuters configuration-ghc-8.4.x.nix
   ghc-configuration [--reuse-cache]
                             Generate configuration-ghc-8.4.x.nix.  Neuters overrides.nix
