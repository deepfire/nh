...
Usage:  nh [--cls] [--trace] [--debug] SUBCMD [SUBARGS..]
  ...
  Generation of overrides:
   ...
   apply [--reuse-cache] [--nixpkgs]
                             Apply all overrides via overrides.nix.  If --nixpkgs is passed, non-local overrides instead serve as definition for /home/deepfire/nixpkgs/pkgs/development/haskell-modules/configuration-ghc-8.4.x.nix
